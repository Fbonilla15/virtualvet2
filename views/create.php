    ...
    <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div>
                    <img src="../assets/images/icon_landing3.png" class="w-32 mx-auto" />
                </div>
                    ...
                    <h2 class="text-red-600 mx-auto max-w-xs"><?php if (isset($_SESSION['register'])) {echo $_SESSION['register'];}?></h2>
                        <form class="flex flex-col justify-center items-center gap-4 p-6" action="../controllers/create.php" method="post">
                            <div class="mx-auto max-w-xs">
                                ...
                                <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="text" placeholder="Nombre" name="name" required />
            ...
            <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
                <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style="background-image: url('../assets/images/icon2.png');">
                </div>
            </div>
        </div>
    </div>
